...
export type Mutation = {
  ...
  /** Delete one series from _all_ existing stages. Returns deleted document. */
  ...
  /** Schedule to publish one series */
  schedulePublishSeries?: Maybe<Series>;
  ...
  /** Unpublish one series from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
  scheduleUnpublishSeries?: Maybe<Series>;
  /** Unpublish one asset from selected stages. Unpublish either the complete document with its relations, localizations and base data or specific localizations only. */
...
export type MutationPublishSeriesArgs = {
  to?: Array<Stage>;
  where: SeriesWhereUniqueInput;
};
...
export type MutationSchedulePublishSeriesArgs = {
  releaseAt?: InputMaybe<Scalars['DateTime']>;
  releaseId?: InputMaybe<Scalars['String']>;
  to?: Array<Stage>;
  where: SeriesWhereUniqueInput;
...
export type MutationScheduleUnpublishSeriesArgs = {
  from?: Array<Stage>;
  releaseAt?: InputMaybe<Scalars['DateTime']>;
  releaseId?: InputMaybe<Scalars['String']>;
  where: SeriesWhereUniqueInput;
...
export type MutationUnpublishSeriesArgs = {
  from?: Array<Stage>;
  where: SeriesWhereUniqueInput;
};
...
export type MutationUpsertSeriesArgs = {
  upsert: SeriesUpsertInput;
  where: SeriesWhereUniqueInput;
};
...
export type PostCreateInput = {
  ...
  series?: InputMaybe<SeriesCreateOneInlineInput>;
  slug: Scalars['String'];
  title: Scalars['String'];
  updatedAt?: InputMaybe<Scalars['DateTime']>;
};
...
export type PostManyWhereInput = {
  ...
  scheduledIn_none?: InputMaybe<ScheduledOperationWhereInput>;
  scheduledIn_some?: InputMaybe<ScheduledOperationWhereInput>;
  series?: InputMaybe<SeriesWhereInput>;
  slug?: InputMaybe<Scalars['String']>;
  /** All values containing the given string. */
  slug_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
...
export type PostUpdateInput = {
  ...
  series?: InputMaybe<SeriesUpdateOneInlineInput>;
  slug?: InputMaybe<Scalars['String']>;
  title?: InputMaybe<Scalars['String']>;
};
...
export type Query = {
  ...
  series?: Maybe<Series>;
  /** Retrieve document version */
  seriesVersion?: Maybe<DocumentVersion>;
...
export type QuerySeriesVersionArgs = {
  where: VersionWhereInput;
};
...
export type ScheduledOperationAffectedDocument = Asset | Category | Post | Series;
...
export type Series = Node & {
  ...
  createdBy?: Maybe<User>;
  /** Get the document in other stages */
  documentInStages: Array<Series>;
  /** List of Series versions */
  history: Array<Version>;
  /** The unique identifier */
  id: Scalars['ID'];
  posts: Array<Post>;
...
export type SeriesCreatedByArgs = {
  locales?: InputMaybe<Array<Locale>>;
};


export type SeriesDocumentInStagesArgs = {
  includeCurrent?: Scalars['Boolean'];
  inheritLocale?: Scalars['Boolean'];
  stages?: Array<Stage>;
};
...
export type SeriesPublishedByArgs = {
  locales?: InputMaybe<Array<Locale>>;
};


export type SeriesScheduledInArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
export type SeriesUpdatedByArgs = {
  locales?: InputMaybe<Array<Locale>>;
};

export type SeriesConnectInput = {
  /** Allow to specify document position in list of connected documents, will default to appending at end of list */
  position?: InputMaybe<ConnectPositionInput>;
  /** Document to connect */
  where: SeriesWhereUniqueInput;
...
export type SeriesCreateManyInlineInput = {
  /** Connect multiple existing Series documents */
  connect?: InputMaybe<Array<SeriesWhereUniqueInput>>;
  /** Create and connect multiple existing Series documents */
  create?: InputMaybe<Array<SeriesCreateInput>>;
};

export type SeriesCreateOneInlineInput = {
  /** Connect one existing Series document */
  connect?: InputMaybe<SeriesWhereUniqueInput>;
  /** Create and connect one Series document */
  create?: InputMaybe<SeriesCreateInput>;
};
...
/** Identifies documents */
export type SeriesManyWhereInput = {
  /** Logical AND on all given filters. */
...
export type SeriesUpdateManyInlineInput = {
  /** Connect multiple existing Series documents */
  connect?: InputMaybe<Array<SeriesConnectInput>>;
  /** Create and connect multiple Series documents */
  create?: InputMaybe<Array<SeriesCreateInput>>;
  /** Delete multiple Series documents */
  delete?: InputMaybe<Array<SeriesWhereUniqueInput>>;
  /** Disconnect multiple Series documents */
  disconnect?: InputMaybe<Array<SeriesWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing Series documents */
  set?: InputMaybe<Array<SeriesWhereUniqueInput>>;
  /** Update multiple Series documents */
  update?: InputMaybe<Array<SeriesUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple Series documents */
  upsert?: InputMaybe<Array<SeriesUpsertWithNestedWhereUniqueInput>>;
};

export type SeriesUpdateManyInput = {
  /** No fields in updateMany data input */
  _?: InputMaybe<Scalars['String']>;
};

export type SeriesUpdateManyWithNestedWhereInput = {
  /** Update many input */
  data: SeriesUpdateManyInput;
  /** Document search */
...
export type SeriesUpdateOneInlineInput = {
  /** Connect existing Series document */
  connect?: InputMaybe<SeriesWhereUniqueInput>;
  /** Create and connect one Series document */
  create?: InputMaybe<SeriesCreateInput>;
  /** Delete currently connected Series document */
  delete?: InputMaybe<Scalars['Boolean']>;
  /** Disconnect currently connected Series document */
  disconnect?: InputMaybe<Scalars['Boolean']>;
  /** Update single Series document */
  update?: InputMaybe<SeriesUpdateWithNestedWhereUniqueInput>;
  /** Upsert single Series document */
  upsert?: InputMaybe<SeriesUpsertWithNestedWhereUniqueInput>;
};

export type SeriesUpdateWithNestedWhereUniqueInput = {
  /** Document to update */
  data: SeriesUpdateInput;
  /** Unique document search */
  where: SeriesWhereUniqueInput;
...
export type SeriesUpsertWithNestedWhereUniqueInput = {
  /** Upsert data */
  data: SeriesUpsertInput;
  /** Unique document search */
  where: SeriesWhereUniqueInput;
};
...
/** References Series record uniquely */
